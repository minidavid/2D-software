local baseSpiral = require("Primitives.Christmas spiral.3DModel")

local listOfSpirals = {}



function MakeChristmasSpiral(x,y,z)
...
function UpdateMadeChristmasSpiral(dt)

    
    if love.keyboard.isDown("right") then
        MakeChristmasSpiral(-1, -1, 20)
    end
...
function DrawMadeChristmasSpiral()
    for _,spiral in ipairs(listOfSpirals) do 
        for i = 1,#spiral do
            local a = spiral[i]
